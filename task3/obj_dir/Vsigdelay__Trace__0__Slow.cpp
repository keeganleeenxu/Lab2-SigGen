...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+10,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count),9);
    bufp->fullCData(oldp+11,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count),8);
    bufp->fullSData(oldp+12,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count) 
